"""
Entry point for Random Forest model integration with the Flask backend.
This module provides a clean interface for the web application to use the Random Forest model.
"""
...
from ml.random_forest.predict import predict_stock_for_api_with_pretrained, predict_stock_for_api
from ml.random_forest.fetch_data import fetch_stock_data
import pandas as pd
from datetime import datetime


def run_prediction(ticker, days_ahead=7, period="2y", n_estimators=100, use_pretrained=True):
    """
    Run Random Forest prediction and return results in API-compatible format.
    ...
    Notes:
        ...
        - Pre-trained models are trained on 5 years of data with 300 trees (better accuracy)
